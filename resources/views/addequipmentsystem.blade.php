        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Add Equipments</h1>
                    ...
                    <div class="row d-sm-flex align-items-center justify-content-between">
                      ...
                      <div class="col-md-8">  
                            <form method="post">
                                ...
                                <div class="form-group">
                                    <label>Select Equipments Type </label>
                                    <select name="selequipment" id="selequipment" class="form-control">
                                ...
                                <div class="form-group">
                                <button class="btn btn-primary form-control" onclick="saveequipments();" >Save Equipments</button>
                                </div>
                            </form>
                       </div>
...
// $('#option5').addClass("optionvsmnote");
        ...
        success: function(response){
            ...
            if(len > 0){
                // Read data and create <option >
                var defaulto="<option>Select Equipment Type</option>";
                $("#selequipment").append(defaulto);
                for(var i=0; i<len; i++){

                var id = response['data'][i].equiptypeid;
                var name = response['data'][i].equipname;

                var option = "<option value='"+id+"'>"+name+"</option>";

                $("#selequipment").append(option); 
                }
            }
...
<script>
    ...
    function saveequipments() {
        ...
        var selequipment=document.getElementById('selequipment').value;
        var stocks=document.getElementById('stocks').value;
        var remarks=document.getElementById('remarks').value;
        
        var urls="saveEquipments";
        var params = 'eqtypeid='+selequipment+"&workid="+selwork+"&stock="+stocks+"&remarks="+remarks;
        var headers = {
    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        console.log(urls);
               ...
               document.getElementById('selequipment').value="";
