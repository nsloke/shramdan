    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Page Heading -->
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Add Equipment Type</h1>
                ...
                <div class="col-md-8">  
                        <form method="post">
                            ...
                            <input type="text" class="form-control" id="equipmenttypename" name="equipmenttypename" placeholder="Equipment Type Name" >
                            </div>
                            ...
                            <div class="form-group">
                            <button class="btn btn-primary form-control" onclick="saveequipmenttype();" >Save Equipment Type</button>
                            </div>
                        </form>
                </div>
...
function saveequipmenttype() {
    ...
    var equipmenttypename=document.getElementById('equipmenttypename').value;

   
    var urls="saveEquipmentType";
    var params = 'equipmenttypename='+equipmenttypename;
    var headers = {
